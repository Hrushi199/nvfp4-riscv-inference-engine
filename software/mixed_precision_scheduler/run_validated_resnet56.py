"""
===========================================================
VALIDATED MIXED-PRECISION SCHEDULER (RESNET-56)
===========================================================

ResNet-56 has ~55 quantizable conv layers — 3x deeper than
ResNet-20. This demonstrates how the validated scheduler
handles deep residual networks with many sensitive layers.
...
Expected runtime on Kaggle T4:
  Training (100 epochs):  ~20 min
  Sensitivity analysis:   ~10 min
  Validated scheduling:   ~30 min (3 budgets x ~55 layers)
  Total:                  ~60 min
...
# =========================================================
# RESNET-56 MODEL (9 blocks per group x 3 groups)
# =========================================================
...
class ResNet56(nn.Module):
    ...
    3 groups x 9 blocks x 2 convs = 54 conv layers
    + 1 initial conv + 2 shortcut convs + 1 FC
    ~855K parameters
    """
...
print("\n=================================================")
print("TRAINING RESNET-56 (100 epochs)")
print("=================================================\n")
