    ...
    unique case (instr_rdata_i[6:0])
      ...
      OPCODE_CUSTOM_0: begin
        if (COREV_PULP && instr_rdata_i[14:13] != 2'b11) begin // cv.l[bhw][u] and cv.elw
          ...
          //////////////////////////////////////////////////////////////
          // NVFP4 Custom ISA Extension (when COREV_PULP=0, FPU=1)
          //////////////////////////////////////////////////////////////
          // Encoding: [31:25]=funct7 | [24:20]=rs2 | [19:15]=rs1 |
          //           [14:12]=funct3 | [11:7]=rd   | [6:0]=0001011
          //
          // funct3=000: NVFP4.LOAD_W rd, rs1, rs2
          //             Load weight_packed[31:0]=rs1, [63:32]=rs2
          // funct3=001: NVFP4.LOAD_A rd, rs1, rs2
          //             Load act_packed[31:0]=rs1, [63:32]=rs2
          // funct3=010: NVFP4.MAC    rd, rs1
          //             Set scale=rs1, trigger compute, result→rd
          // funct3=011: NVFP4.STORE  rd
          //             Read accelerator result into rd
          //////////////////////////////////////////////////////////////
          if (FPU == 1) begin
            // Route to APU (not ALU)
            alu_en      = 1'b0;
            apu_en      = 1'b1;
            // Use integer registers (ZFINX mode)
            reg_fp_a_o  = 1'b0;
            reg_fp_b_o  = 1'b0;
            reg_fp_d_o  = 1'b0;
            ...
            unique case (instr_rdata_i[14:12])
              ...
              3'b000: begin // NVFP4.LOAD_W rd, rs1, rs2
                rega_used_o = 1'b1;
                regb_used_o = 1'b1;
                apu_op_o    = 6'b000001;
                apu_lat_o   = 2'h1;
              end
              3'b001: begin // NVFP4.LOAD_A rd, rs1, rs2
                rega_used_o = 1'b1;
                regb_used_o = 1'b1;
                apu_op_o    = 6'b000010;
                apu_lat_o   = 2'h1;
              end
              3'b010: begin // NVFP4.MAC rd, rs1
                rega_used_o = 1'b1;
                apu_op_o    = 6'b000100;
                apu_lat_o   = 2'h3;
              end
              3'b011: begin // NVFP4.STORE rd
                apu_op_o    = 6'b001000;
                apu_lat_o   = 2'h1;
              end
              // ---- BF16 Instructions (funct3=100..110) ----
              3'b100: begin // BF16.LOAD_W rd, rs1, rs2
                rega_used_o = 1'b1;
                regb_used_o = 1'b1;
                apu_op_o    = 6'b010001;
                apu_lat_o   = 2'h1;
              end
              3'b101: begin // BF16.LOAD_A rd, rs1, rs2
                rega_used_o = 1'b1;
                regb_used_o = 1'b1;
                apu_op_o    = 6'b010010;
                apu_lat_o   = 2'h1;
              end
              3'b110: begin // BF16.MAC rd
                apu_op_o    = 6'b010100;
                apu_lat_o   = 2'h3;
              end
              default: illegal_insn_o = 1'b1;
